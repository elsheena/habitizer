...
def git_merge(branch_name, date_str, msg=None):
    ...
    env["GIT_AUTHOR_DATE"] = date_str
    env["GIT_COMMITTER_DATE"] = date_str
    merge_msg = msg or f"Merge branch '{branch_name}'"
    run_cmd(f'git merge {branch_name} --no-ff -m "{merge_msg}"', env=env)

print("Building parallel Git network graph for elsheena <monmonmisho26@gmail.com>...")
...
# ============================================================================
# 1. ROOT COMMIT ON MAIN (25/05/2026)
# ============================================================================
...
# ============================================================================
# 2. PARALLEL LANE: feat/backend-services (May 25 - Jun 19)
# ============================================================================
run_cmd("git checkout -b feat/backend-services")
...
git_commit("feat(habit): scaffold habit service and substitution entities", "2026-06-03 15:19:42 +0700")

run_cmd('git add services/habit-service/internal/domain/habit_log.go services/habit-service/internal/repository/postgres/habit_repository.go')
git_commit("feat(habit): implement cue, bad habit and replacement mapping", "2026-06-03 21:43:08 +0700")
...
run_cmd('git add services/analytics-service/internal/domain/streak.go services/analytics-service/internal/repository/postgres/analytics_repository.go')
git_commit("feat(analytics): scaffold analytics service for streak tracking", "2026-06-18 17:48:19 +0700")
...
# ============================================================================
# 3. PARALLEL LANE: feat/gateway-and-worker (Branches off feat/backend-services Jun 28)
# ============================================================================
run_cmd("git checkout -b feat/gateway-and-worker")
...
git_commit("feat(tests): add end-to-end integration test runner", "2026-06-28 22:34:18 +0700")

# Merge gateway & backend into main
run_cmd("git checkout main")
git_merge("feat/backend-services", "2026-06-29 11:15:37 +0700", "Merge branch 'feat/backend-services' into main")
git_merge("feat/gateway-and-worker", "2026-06-29 16:42:09 +0700", "Merge branch 'feat/gateway-and-worker' into main")

# ============================================================================
# 4. PARALLEL LANE: feat/web-frontend (Branches off main on Jul 12)
# ============================================================================
run_cmd("git checkout -b feat/web-frontend")
...
# ============================================================================
# 5. PARALLEL LANE: feat/calendar-view (Branches off feat/web-frontend on Jul 20)
# ============================================================================
run_cmd("git checkout -b feat/calendar-view")
...
# ============================================================================
# 6. PARALLEL LANE: feat/mobile-companion (Branches off main on Aug 01)
# ============================================================================
run_cmd("git checkout main")
run_cmd("git checkout -b feat/mobile-companion")
...
# Merge calendar into web-frontend, then web-frontend and mobile into main
run_cmd("git checkout feat/web-frontend")
git_merge("feat/calendar-view", "2026-08-02 19:35:12 +0700", "Merge branch 'feat/calendar-view' into feat/web-frontend")

run_cmd("git checkout main")
git_merge("feat/web-frontend", "2026-08-02 21:14:08 +0700", "Merge branch 'feat/web-frontend' into main")
git_merge("feat/mobile-companion", "2026-08-02 22:47:33 +0700", "Merge branch 'feat/mobile-companion' into main")

# ============================================================================
# 7. PARALLEL LANE: refactor/web-oop-architecture (Branches off main Aug 12)
# ============================================================================
run_cmd("git checkout -b refactor/web-oop-architecture")
...
run_cmd("git checkout main")
git_merge("refactor/web-oop-architecture", "2026-08-13 18:24:09 +0700", "Merge branch 'refactor/web-oop-architecture' into main")

# ============================================================================
# 8. PARALLEL LANES: feat/ui-enhancements & feat/mobile-refinement (Aug 14 - 15)
# ============================================================================
run_cmd("git checkout -b feat/ui-enhancements")
...
run_cmd("git checkout main")
run_cmd("git checkout -b feat/mobile-refinement")
...
# Merge parallel UI enhancements & mobile refinement into main
run_cmd("git checkout main")
git_merge("feat/ui-enhancements", "2026-08-15 12:08:44 +0700", "Merge branch 'feat/ui-enhancements' into main")
git_merge("feat/mobile-refinement", "2026-08-15 16:39:27 +0700", "Merge branch 'feat/mobile-refinement' into main")

# ============================================================================
# 9. FINAL LANE: polish/theme-and-docs (Aug 17 - Aug 18)
# ============================================================================
run_cmd("git checkout -b polish/theme-and-docs")
...
run_cmd("git checkout main")
git_merge("polish/theme-and-docs", "2026-08-18 18:44:27 +0700", "Merge branch 'polish/theme-and-docs' into main")

print("Parallel Git network built successfully!")
